...
alert=[
    [' ', ' ', ' ', ' ', ' ', ' ', ' ', '/', '\\', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '/', '\\', ' '], 
[' ', ' ', ' ', ' ', ' ', ' ', '/', ' ', ' ', '\\', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '/', ' ', ' ', '\\', ' '], [' ', ' ', ' ', ' ', ' ', '/', ' ', '|', ' ', ' ', '\\', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '/', ' ', '|', ' ', ' ', '\\', ' '], [' ', ' ', ' ', ' ', '/', ' ', ' ', '|', ' ', ' ', ' ', '\\', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '/', ' ', ' ', '|', ' ', ' ', ' ', '\\', ' '], [' ', ' ', ' ', '/', ' ', ' ', ' ', '|', ' ', ' ', ' ', ' ', '\\', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '/', ' ', ' ', ' ', '|', ' ', ' ', ' ', ' ', '\\', ' '], [' ', ' ', '/', ' ', ' ', ' ', ' ', '_', ' ', ' ', ' ', ' ', ' ', '\\', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '/', ' ', ' ', ' ', ' ', '_', ' ', ' ', ' ', ' ', ' ', '\\', ' '], [' ', '/', ' ', ' ', ' ', ' ', '|', '_', '|', ' ', ' ', ' ', ' ', ' ', '\\', ' ', ' ', '!', 'L', "'", 'a', 'c', 't', 'i', 'o', 'n', ' ', 'à', ' ', 'l', 'a', 'q', 'u', 'e', 'l', 'l', 'e', ' ', 'v', 'o', 'u', 's', ' ', 'v', 'o', 'u', 's', ' ', 'a', 'p', 'p', 'r', 'é', 't', 'e', 'z', ' ', 'e', 's', 't', ' ', 'i', 'r', 'r', 'é', 'v', 'e', 'r', 's', 'i', 'b', 'l', 'e', ' ', ' ', '/', ' ', ' ', ' ', ' ', '|', '_', '|', ' ', ' ', ' ', ' ', ' ', '\\', ' '], ['/', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_', '\\', ' ', ' ', ' ', ' ', ' ', ' ', 'ê', 't', 'e', 's', '-', 'v', 'o', 'u', 's', ' ', 's', 'û', 'r', 'e', ' ', 'd', 'e', ' ', 'v', 'o', 'u', 'l', 'o', 'i', 'r', ' ', 's', 'u', 'p', 'p', 'r', 'i', 'm', 'e', 'r', ' ', 'c', 'e', ' ', 's', 'p', 'r', 'i', 't', 'e', '?', '!', ' ', ' ', ' ', ' ', ' ', '/', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_', '\\', ' '], []]
face=[[' ', ' ', ' ', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_'], [' ', ' ', '/', ' ', '_', '_', ' ', ' ', ' ', '_', '_', ' ', ' ', '\\'], [' ', '/', ' ', '|', '_', '_', '|', ' ', '|', '_', '_', '|', ' ', ' ', '\\'], ['|', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '|'], [' ', '\\', ' ', '\\', '_', '_', '_', '_', '_', '_', '_', '_', '/', ' ', '/'], [' ', ' ', '\\', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_', '/'], []]
facesad=[[' ', ' ', ' ', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_'], [' ', ' ', '/', ' ', '_', '_', ' ', ' ', ' ', '_', '_', ' ', ' ', '\\'], [' ', '/', ' ', '|', '_', '_', '|', ' ', '|', '_', '_', '|', ' ', ' ', '\\'], ['|', ' ', ' ', ' ', '_', '_', '_', '_', '_', '_', '_', '_', ' ', ' ', ' ', '|'], [' ', '\\', ' ', '/', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '\\', ' ', '/'], [' ', ' ', '\\', '_', '_', '_', '_', '_', '_', '_', '_', '_', '_', '/'], []]
rounded=False
class edditing:
    ...
    def remove(spritelist):
        ...
        print("GetSpriteListID={}".format(type(GetSpriteListID)))
        if GetSpriteListID.isnumeric()==True:
            print("if GetSpriteListID.isnumeric()==True:{}".format(GetSpriteListID.isnumeric()))
            for i in range(len(spritelist)):
                print("for i ({}) in range(len(spritelist)-1):{}".format(i,len(spritelist)))
                if spritelist[i]["SpriteId"]==str(GetSpriteListID):
                    print("if spritelist[i][\"SpriteId\"]")
