...
def Niveau___init__(fichier):
    self_fichier = "levels/{}".format(fichier)
    self_structure = 0
    return self_fichier,self_structure

def generer(self_fichier,self_structure):
    """Méthode permettant de générer le niveau en fonction du fichier.
    On crée une liste générale, contenant une liste par ligne à afficher"""	
    #On ouvre le fichier
    with open(self_fichier, "r") as fichier:
        structure_niveau = []
	    ...
	    self_structure = structure_niveau
    return self_fichier,self_structure,ligne_niveau,structure_niveau,self_structure

def afficher(self_fichier,self_structure,ligne_niveau,structure_niveau,self_structure, fenetre,image_mur,image_depart,image_arrivee,image_arrivee_fam,adown,aup,aleft,aright,a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z):
		...
		for ligne in self.structure:
			...
			for sprite in ligne:
				...
				num_case += 1
			num_ligne += 1
    return self_fichier,self_structure,ligne_niveau,structure_niveau,self_structure, fenetre,num_case,num_ligne
